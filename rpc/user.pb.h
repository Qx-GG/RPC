...
class ResultCode :
 ...
 public:
  ...
  void set_errmesg(const std::string& value);
  void set_errmesg(std::string&& value);
  void set_errmesg(const char* value);
  void set_errmesg(const void* value, size_t size);
  std::string* mutable_errmesg();
  std::string* release_errmesg();
  void set_allocated_errmesg(std::string* errmesg);
  private:
  const std::string& _internal_errmesg() const;
  void _internal_set_errmesg(const std::string& value);
...
class LoginResponse :
 ...
 public:
  ...
  // .RPC.ResultCode res = 1;
  bool has_res() const;
  private:
  bool _internal_has_res() const;
  public:
  void clear_res();
  const ::RPC::ResultCode& res() const;
  ::RPC::ResultCode* release_res();
  ::RPC::ResultCode* mutable_res();
  void set_allocated_res(::RPC::ResultCode* res);
  private:
  const ::RPC::ResultCode& _internal_res() const;
  ::RPC::ResultCode* _internal_mutable_res();
  public:
...
inline void ResultCode::clear_errmesg() {
  errmesg_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& ResultCode::errmesg() const {
  // @@protoc_insertion_point(field_get:RPC.ResultCode.errmesg)
  return _internal_errmesg();
}
inline void ResultCode::set_errmesg(const std::string& value) {
  _internal_set_errmesg(value);
  // @@protoc_insertion_point(field_set:RPC.ResultCode.errmesg)
}
inline std::string* ResultCode::mutable_errmesg() {
  // @@protoc_insertion_point(field_mutable:RPC.ResultCode.errmesg)
  return _internal_mutable_errmesg();
}
inline const std::string& ResultCode::_internal_errmesg() const {
  return errmesg_.GetNoArena();
}
inline void ResultCode::_internal_set_errmesg(const std::string& value) {
  
  errmesg_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void ResultCode::set_errmesg(std::string&& value) {
  
  errmesg_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:RPC.ResultCode.errmesg)
}
inline void ResultCode::set_errmesg(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  errmesg_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:RPC.ResultCode.errmesg)
}
inline void ResultCode::set_errmesg(const void* value, size_t size) {
  
  errmesg_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:RPC.ResultCode.errmesg)
}
inline std::string* ResultCode::_internal_mutable_errmesg() {
  
  return errmesg_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* ResultCode::release_errmesg() {
  // @@protoc_insertion_point(field_release:RPC.ResultCode.errmesg)
  
  return errmesg_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void ResultCode::set_allocated_errmesg(std::string* errmesg) {
  ...
  errmesg_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), errmesg);
  // @@protoc_insertion_point(field_set_allocated:RPC.ResultCode.errmesg)
}
...
inline const ::RPC::ResultCode& LoginResponse::_internal_res() const {
  const ::RPC::ResultCode* p = res_;
  return p != nullptr ? *p : *reinterpret_cast<const ::RPC::ResultCode*>(
      &::RPC::_ResultCode_default_instance_);
}
inline const ::RPC::ResultCode& LoginResponse::res() const {
  // @@protoc_insertion_point(field_get:RPC.LoginResponse.res)
  return _internal_res();
}
inline ::RPC::ResultCode* LoginResponse::release_res() {
  // @@protoc_insertion_point(field_release:RPC.LoginResponse.res)
  
  ::RPC::ResultCode* temp = res_;
  res_ = nullptr;
  return temp;
}
inline ::RPC::ResultCode* LoginResponse::_internal_mutable_res() {
...
inline ::RPC::ResultCode* LoginResponse::mutable_res() {
  // @@protoc_insertion_point(field_mutable:RPC.LoginResponse.res)
  return _internal_mutable_res();
}
inline void LoginResponse::set_allocated_res(::RPC::ResultCode* res) {
  ...
  res_ = res;
  // @@protoc_insertion_point(field_set_allocated:RPC.LoginResponse.res)
}
...
inline void RegisterResponse::clear_res() {
  if (GetArenaNoVirtual() == nullptr && res_ != nullptr) {
    delete res_;
  }
  res_ = nullptr;
}
inline const ::RPC::ResultCode& RegisterResponse::_internal_res() const {
  const ::RPC::ResultCode* p = res_;
  return p != nullptr ? *p : *reinterpret_cast<const ::RPC::ResultCode*>(
      &::RPC::_ResultCode_default_instance_);
}
inline const ::RPC::ResultCode& RegisterResponse::res() const {
  // @@protoc_insertion_point(field_get:RPC.RegisterResponse.res)
  return _internal_res();
}
inline ::RPC::ResultCode* RegisterResponse::release_res() {
  // @@protoc_insertion_point(field_release:RPC.RegisterResponse.res)
  
  ::RPC::ResultCode* temp = res_;
  res_ = nullptr;
  return temp;
}
inline ::RPC::ResultCode* RegisterResponse::_internal_mutable_res() {
...
inline ::RPC::ResultCode* RegisterResponse::mutable_res() {
  // @@protoc_insertion_point(field_mutable:RPC.RegisterResponse.res)
  return _internal_mutable_res();
}
inline void RegisterResponse::set_allocated_res(::RPC::ResultCode* res) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete res_;
  }
  ...
  res_ = res;
  // @@protoc_insertion_point(field_set_allocated:RPC.RegisterResponse.res)
}
